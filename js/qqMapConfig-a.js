var selectMapTemplate =
    `<div class="select-tree-module">
        ...
        <div class="search-module">
            <el-input style="width:85%;float:left;" placeholder="输入想找的地点" v-model="mapKeWordy" @keyup.enter.native="searchMapkey"></el-input>
...
Vue.component('select-map', {
    ...
    methods: {
        ...
        mapGeocoderFun() {
            ...
            self.geocoder.setComplete(function (result) {
                ...
                self.infoWin.setContent('<div id="mapinfo" style="width:200px;">' +
                    ...
                    '<input type="text" class="mapRadiusInput" id="mapRadiusInput" value="3000">' +
        ...
        addRadius() {
            ...
            self.mapradius += 500;
			self.mapradius = self.mapradius>15000?15000:self.mapradius
        ...
        reduceRadius() {
            if (self.mapradius >= 0.5){
                // let value = self.mapradius - 0.5;
                self.mapradius -= 500;
				self.mapradius = self.mapradius<3000?3000:self.mapradius
                // document.getElementById('mapRadiusInput').value = value;
                document.getElementById('mapRadiusInput').value = self.mapradius;
                // self.circle.setRadius(value * 1000);
                self.circle.setRadius(self.mapradius);
        ...
        getChangeRadius() {
            ...
            if(mapradius<3000 || mapradius>15000){
				alert("半径范围3000-15000")
				return;
			}
